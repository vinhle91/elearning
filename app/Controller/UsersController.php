...
//                if (isset($data['User']['VerifyCodeQuestion']) && !empty($data['User']['VerifyCodeQuestion'])&& isset($data['User']['VerifyCodeAnswer']) && !empty($data['User']['VerifyCodeAnswer'])) {
                    echo "Verify code :" . $data['User']['VerifyCodeQuestion'];
