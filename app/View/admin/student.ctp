                ...
                <div class="col-md-6">
                    <div class="portlet">
                        <div class="portlet-title">
                            <div class="caption"><i class="fa fa-user"></i>新しい学生</div>
                        </div>
                            ...
                            <tbody>
                                <?php foreach ($all_students['Data'] as $key => $student) { ?>
                                    <tr>
                                        ...
                                        <td class="text-align-right"><?php echo $student['User']['Violated'] == 0 ? null : $student['User']['Violated']; ?></td>
						...
						<div class="col-md-12">
							<table id="user" class="table table-striped table-bordered">
								<tbody>
									...
									<tr>
										<td>クレジットカード情報</td>
										<td><input type="text" id="CreditCard" name="CreditCard" value="<?php echo $studentInfo['CreditCard']?>"></input><span class="edit-btn pull-right fa fa-edit pointer" data-toggle="modal" href="#portlet-config"></span></td>
									</tr>
									<tr>
										<td>住所</td>
...
<script type="text/javascript">
	...
	$("#user-info-form").live("submit", function(e){
		if ($("#user-info-form").validate().checkForm() == false) {
			...
			submit_data.CreditCard = "'"+$('#CreditCard').val().trim()+"'";
