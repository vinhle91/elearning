						...
						<div class="col-md-12">
							<table id="user" class="table table-bordered table-striped">
								<tbody>
									...
									<tr>
										<td>状態</td>
										<td><section class="pull-left padding-5" id="Status"><span class="label label-<?php echo $status_label[$studentInfo['Status']] ?> line-height-6"><?php echo $status[$studentInfo['Status']] ?></span></section></td>
									</tr>		
									<?php } ?>							
									<tr>
										<td>生年月日</td>
										<td><section class="pull-left editable padding-5" id="Birthday"><?php echo $studentInfo['Birthday']  ? $studentInfo['Birthday'] : "<i>更新している... </i>"?></section><span class="config pull-right fa fa-edit pointer" data-toggle="modal" href="#portlet-config"></span></td>
										
									</tr>
									<tr>
										<td>クレジットカード情報</td>
										<td><section class="pull-left editable padding-5" id="BankInfo"><?php echo $studentInfo['BankInfo'] ? $studentInfo['BankInfo'] : "<i>更新している...</i>"?></section><span class="config pull-right fa fa-edit pointer" data-toggle="modal" href="#portlet-config"></span></td>
									</tr>
									<tr>
										<td>住所</td>
										<td><section class="pull-left editable padding-5" id="Address"><?php echo $studentInfo['Address']  ? $studentInfo['Address'] : "<i>更新している...</i>"?></section><span class="config pull-right fa fa-edit pointer" data-toggle="modal" href="#portlet-config"></span></td>
									</tr>							
								</tbody>
							</table>
	...
	$(document).ready(function(){
		...
		$(".editable").on("click", function(){
			...
			$(".button-save").on("click", function(){
				var url = "/elearning/admin/setUserInfo";
