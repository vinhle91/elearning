						...
						<div class="col-md-12">
							<table id="user" class="table table-bordered table-striped">
								<tbody>
									...
									<tr>
										<td>生年月日</td>
										<td><section class="pull-left editable padding-5" id="Birthday"><?php echo $teacherInfo['Birthday']  ? $teacherInfo['Birthday'] : "<i>更新している... </i>"?></section><span class="config pull-right fa fa-edit pointer" data-toggle="modal" href="#portlet-config"></span></td>
										
									</tr>
									<tr>
										<td>クレジットカード情報</td>
										<td><section class="pull-left editable padding-5" id="BankInfo"><?php echo $teacherInfo['BankInfo'] ? $teacherInfo['BankInfo'] : "<i>更新している...</i>"?></section><span class="config pull-right fa fa-edit pointer" data-toggle="modal" href="#portlet-config"></span></td>
									</tr>
									<tr>
										<td>住所</td>
										<td><section class="pull-left editable padding-5" id="Address"><?php echo $teacherInfo['Address']  ? $teacherInfo['Address'] : "<i>更新している...</i>"?></section><span class="config pull-right fa fa-edit pointer" data-toggle="modal" href="#portlet-config"></span></td>
									</tr>							
								</tbody>
							</table>
	...
	$(document).ready(function(){
		...
		$(".editable").on("click", function(){
			...
			$(".button-save").on("click", function(){
				...
				var submit_data = {UserId: "<?php echo $teacherInfo['UserId']?>",Username: '\''+$('#Username').text()+'\'', Birthday: '\''+$('#Birthday').text()+'\'', BankInfo: '\''+$('#BankInfo').text()+'\'', Address: '\''+$('#Address').text()+'\''}
