            ...
            <div class="left">
                <ul>
                    <li>                             
                        <?php
                        if (isset($topLessons)) {
                            echo $this->Html->link('授業', array('controller' => 'Users', 'action' => 'index', '?' => array('top' => 'lesson')), array('class' => 'selected'));
                        } else {
                            echo $this->Html->link('授業', array('controller' => 'Users', 'action' => 'index', '?' => array('top' => 'lesson')));
                        }
                        ?>                        
                    </li>
                    <li>
                        <?php
                        if (isset($topTeachers)) {
                            echo $this->Html->link('先生', array('controller' => 'Users', 'action' => 'index', '?' => array('top' => 'teacher')), array('class' => 'selected'));
                        } else {
                            echo $this->Html->link('先生', array('controller' => 'Users', 'action' => 'index', '?' => array('top' => 'teacher')));
                        }
                        ?>                     
                    </li>
                </ul>
